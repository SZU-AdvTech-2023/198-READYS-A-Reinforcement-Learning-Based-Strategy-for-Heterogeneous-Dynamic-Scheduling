...
parser.add_argument('--num_processes', type=int, default=4, help='num proc')  # 改
...
parser.add_argument('--optimizer', type=str, default='adm', help='sgd or adam or rms')
parser.add_argument('--scheduler', type=str, default='cyclic', help='lambda or cyclic')
...
parser.add_argument('--entropy_coef', type=float, default=0.001, help='entropy loss weight')
parser.add_argument('--gamma', type=float, default=0.99, help='inflation')
parser.add_argument('--loss_ratio', type=float, default=0.5, help='value loss weight')
parser.add_argument('--trajectory_length', type=int, default=60, help='batch size')  # 改
...
parser.add_argument('--ngcn', type=int, default=4, help='number of gcn')
parser.add_argument('--nmlp', type=int, default=2, help='number of mlp to compute probs')
parser.add_argument('--nmlp_value', type=int, default=2, help='number of mlp to compute v')
...
parser.add_argument('--nCPU', type=int, default=4, help='number of cores')
parser.add_argument('--window', type=int, default=2, help='window')
parser.add_argument('--noise', type=float, default=0.5, help='noise')
...
writer = SummaryWriter('runs-show1')
